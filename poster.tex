...
\begin{columns}
  ...
  \myblock{The Statistical Problem}{
    ...
    $O$ does not include $V$, though the complete data $X$ does. \\

    Let $O \sim P_0 \in \M$, with $\M$ being the nonparametric \textit{statistical model}. Likelihood of the observed data under $\M$ is:
    \begin{equation*}
