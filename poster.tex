...
\begin{columns}
  ...
  \myblock{Estimation \& Inference}{
    ...
    \end{itemize}
    Both estimators are \textit{multiple-robust} (by being based on the
    efficient influence function), \textit{asymptotically linear} under fairly
    non-restrictive assumptions, compatible with \textit{cross-fitting} of
    nuisance estimators.
    \\
